        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActivityState = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ShopBaskets_User_UserId",
                        column: x => x.UserId,
                        principalTable: "User",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShopBasketRows", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ShopBasketRows_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ShopBasketRows_ShopBaskets_ShopBasketId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShopBasketRows_ShopBasketId",
                table: "ShopBasketRows",
                column: "ShopBasketId");

            migrationBuilder.CreateIndex(
                name: "IX_ShopBaskets_UserId",
                table: "ShopBaskets",
                column: "UserId");
